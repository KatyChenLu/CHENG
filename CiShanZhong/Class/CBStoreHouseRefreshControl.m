...
{
    return self.scrollView.contentOffset.y + self.originalTopContentInset -64;
}
...
//        UIEdgeInsets * edge = UIEdgeInsetsMake(newInsets.top - 40, newInsets.left, newInsets.bottom, newInsets.right);
        UIEdgeInsets insets = {newInsets.top-40, newInsets.left, newInsets.bottom, newInsets.right};
